    ...
    public partial class Criandousuario : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoffeeUser", x => x.USUARIO);
                });

            migrationBuilder.CreateTable(
                name: "CreateUserInsert",
                columns: table => new
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DadosCadastro", x => x.DOCUMENTO);
                    table.ForeignKey(
                        name: "FK_DadosCadastro_CoffeeUser_USUARIO",
                        column: x => x.USUARIO,
                        principalTable: "CoffeeUser",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_CAD = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    USUARIO = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DadosEndereco", x => x.ID_CAD);
                    table.ForeignKey(
                        name: "FK_DadosEndereco_CoffeeUser_USUARIO",
                        column: x => x.USUARIO,
                        principalTable: "CoffeeUser",
                        principalColumn: "USUARIO",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DadosCadastro_USUARIO",
                table: "DadosCadastro",
                column: "USUARIO",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DadosEndereco_USUARIO",
                table: "DadosEndereco",
                column: "USUARIO",
                unique: true);
        }
